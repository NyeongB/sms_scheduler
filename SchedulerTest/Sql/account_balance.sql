...
INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS)
VALUES(BALANCE_SEQ.NEXTVAL, 1, SYSDATE, 2000, '충전으로 인한 증감');

-- 확인
SELECT BALANCE_NO AS NO, BALANCE_TYPE AS TYPE, BALANCE_COIN AS COIN,
BALANCE_CONTENTS AS CONTENTS, to_char(BALANCE_DATE,'yyyy/mm/dd hh24:mi:ss') AS "DATE"
FROM BALANCE;