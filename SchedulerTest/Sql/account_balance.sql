...
VALUES(BALANCE_SEQ.NEXTVAL, 1, SYSDATE, 7000, '충전으로 인한 증감', 'ccn_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS, USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 1, SYSDATE, 1000, '충전으로 인한 증감', 'kbj_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS, USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 1, SYSDATE, 1000, '충전으로 인한 증감', 'kbh_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS, USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 1, SYSDATE, 1000, '충전으로 인한 증감', 'cdi_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS,USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 0, SYSDATE, 0, '문자 발송 기본 값','kbj_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS, USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 0, SYSDATE, 0, '문자 발송 기본 값','kbh_01');

INSERT INTO BALANCE(BALANCE_NO, BALANCE_TYPE, BALANCE_DATE, BALANCE_COIN, BALANCE_CONTENTS, USER_ID)
VALUES(BALANCE_SEQ.NEXTVAL, 0, SYSDATE, 0, '문자 발송 기본 값','cdi_01');
